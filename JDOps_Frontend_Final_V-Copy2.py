...
def render_tabs():
    ...
    tabs = ["JD Versions", "Feedback Loop", "Candidate Ranking", "Interview Prep"]
    
    # Create tab buttons that look like the ones in the screenshot
...
def render_jd_refine_page(logger, analyzer, agent):
    ...
    if st.session_state.get('viewing_all_feedback', False):
        st.markdown(f"<div class='section-header'>📋 All Feedback History</div>", unsafe_allow_html=True)
